...
#  Purpose:
#  --------
#  A quick command reference for common Vim/Neovim operations. Run this script
#  anytime you forget a command or need to look something up quickly.
#
#  This is NOT a substitute for learning Vim properly. For that, run 'vimtutor'
#  or visit https://www.openvim.com/
#
# ====================================================================================
